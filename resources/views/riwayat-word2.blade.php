    ...
    <div class="page-container">
        ...
        @if(isset($data->agunan_tanah) && $data->agunan_tanah->count() > 0)
            @foreach($data->agunan_tanah as $index => $agunan)
                ...
                <table class="export-table" style="width: 100%; border-collapse: collapse; border: 1px solid #0A3370 !important; margin-top: 10px; margin-bottom: 10px; table-layout: fixed;">
                    <thead>
                        <tr>
                            <th colspan="6" bgcolor="#0A3370" style="background-color: #0A3370 !important; color: #FFFFFF !important; font-weight: bold; padding: 6px 10px; text-transform: uppercase; border: 1px solid #0A3370 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; text-align: left;">
                    ...
                    <tbody>
                        <!-- Sub Header JAMINAN -->
                        <tr>
                            <td colspan="6" bgcolor="#f3f4f6" style="background-color: #f3f4f6 !important; color: #0A3370 !important; font-weight: bold; text-transform: uppercase; border: 1px solid #0A3370 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 6px 10px; text-align: left;">
                        ...
                        <!-- Kepemilikan -->
                        <tr>
                            <td colspan="2" bgcolor="#f3f4f6" class="bg-label" style="width: 25%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px;">Kepemilikan</td>
                            <td colspan="4" style="width: 75%; border: 1px solid #0A3370 !important; padding: 8px; font-weight: bold;">{{ $agunan->kepemilikan ?? '-' }}</td>
                        </tr>
                        
                        <!-- Alamat -->
                        <tr>
                            <td colspan="2" bgcolor="#f3f4f6" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px;">Alamat</td>
                            <td colspan="4" style="border: 1px solid #0A3370 !important; padding: 8px;">{{ $agunan->alamat ?? '-' }}</td>
                        </tr>
                        
                        <!-- Share Loc -->
                        <tr>
                            <td colspan="2" bgcolor="#f3f4f6" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px;">Share Loc</td>
                            <td colspan="4" style="border: 1px solid #0A3370 !important; padding: 8px;">
                        ...
                        <tr class="sub-header" style="text-align: center; background-color: #f9fafb; color: #000000;">
                            <td bgcolor="#f3f4f6" style="width: 20%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; text-align: center; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; color: #000000;">Uraian</td>
                            <td bgcolor="#f3f4f6" style="width: 12%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; text-align: center; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; color: #000000;">Luas (m2)</td>
                            <td bgcolor="#f3f4f6" style="width: 16%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; text-align: right; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; color: #000000;">Harga</td>
                            <td bgcolor="#f3f4f6" style="width: 17%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; text-align: right; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; color: #000000;">Nilai Pasar</td>
                            <td bgcolor="#f3f4f6" style="width: 17%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; text-align: right; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; color: #000000;">Nilai Taksasi</td>
                            <td bgcolor="#f3f4f6" style="width: 18%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; text-align: right; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; color: #000000;">Nilai Likuidasi</td>
                        </tr>
                        <tr>
                            <td bgcolor="#f3f4f6" class="bg-label font-bold" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px;">Tanah</td>
                            <td class="text-center" style="border: 1px solid #0A3370 !important; text-align: center; padding: 8px;">{{ $agunan->luas_tanah ?? '-' }}</td>
                            <td class="text-right" style="border: 1px solid #0A3370 !important; text-align: right; padding: 8px;">Rp<br>{{ number_format($hargaTanah, 0, ',', '.') }}</td>
                            <td class="text-right" style="border: 1px solid #0A3370 !important; text-align: right; padding: 8px;">Rp<br>{{ number_format($tanahPasar, 0, ',', '.') }}</td>
                            <td class="text-right" style="border: 1px solid #0A3370 !important; text-align: right; padding: 8px;">Rp<br>{{ number_format($tanahTaksasi, 0, ',', '.') }}</td>
                            <td class="text-right" style="border: 1px solid #0A3370 !important; text-align: right; padding: 8px;">Rp<br>{{ number_format($tanahLikuidasi, 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td bgcolor="#f3f4f6" class="bg-label font-bold" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px;">Bangunan</td>
                            <td class="text-center" style="border: 1px solid #0A3370 !important; text-align: center; padding: 8px;">{{ $agunan->luas_bangunan ?? '-' }}</td>
                            <td class="text-right" style="border: 1px solid #0A3370 !important; text-align: right; padding: 8px;">Rp<br>{{ number_format($hargaBangunan, 0, ',', '.') }}</td>
                            <td class="text-right" style="border: 1px solid #0A3370 !important; text-align: right; padding: 8px;">Rp<br>{{ number_format($bangunanPasar, 0, ',', '.') }}</td>
                            <td class="text-right" style="border: 1px solid #0A3370 !important; text-align: right; padding: 8px;">Rp<br>{{ number_format($bangunanTaksasi, 0, ',', '.') }}</td>
                            <td class="text-right" style="border: 1px solid #0A3370 !important; text-align: right; padding: 8px;">Rp<br>{{ number_format($bangunanLikuidasi, 0, ',', '.') }}</td>
                        </tr>
                        <tr class="font-bold bg-label">
                            <td colspan="3" bgcolor="#f3f4f6" class="text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; text-align: center; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px;">TOTAL</td>
                            <td bgcolor="#f3f4f6" class="text-right" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; text-align: right; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px;">Rp<br>{{ number_format($tanahPasar + $bangunanPasar, 0, ',', '.') }}</td>
                            <td bgcolor="#f3f4f6" class="text-right" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; text-align: right; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px;">Rp<br>{{ number_format($tanahTaksasi + $bangunanTaksasi, 0, ',', '.') }}</td>
                            <td bgcolor="#f3f4f6" class="text-right" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; text-align: right; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px;">Rp<br>{{ number_format($tanahLikuidasi + $bangunanLikuidasi, 0, ',', '.') }}</td>
                        </tr>

                        <!-- Spesifikasi Jaminan -->
                        <tr>
                            <td colspan="2" bgcolor="#f3f4f6" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top;">Spesifikasi Jaminan</td>
                            <td colspan="4" style="border: 1px solid #0A3370 !important; padding: 8px; white-space: pre-line; text-align: justify; text-justify: inter-word;">{{ $agunan->spesifikasi ?? '-' }}</td>
                        </tr>

                        <!-- Denah -->
                        <tr>
                            <td colspan="2" bgcolor="#f3f4f6" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top;">Denah</td>
                            <td colspan="4" style="border: 1px solid #0A3370 !important; padding: 8px; text-align: left;">
                        ...
                        <!-- Informasi Harga 1 -->
                        <tr>
                            <td bgcolor="#f3f4f6" class="bg-label text-center" style="width: 10%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">1</td>
                            <td colspan="5" style="border: 1px solid #0A3370 !important; padding: 8px; white-space: pre-line; text-align: justify; text-justify: inter-word; vertical-align: top;">{{ $agunan->info_harga1 ?? '-' }}</td>
                        </tr>
                        <!-- Informasi Harga 2 -->
                        <tr>
                            <td bgcolor="#f3f4f6" class="bg-label text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">2</td>
                            <td colspan="5" style="border: 1px solid #0A3370 !important; padding: 8px; white-space: pre-line; text-align: justify; text-justify: inter-word; vertical-align: top;">{{ $agunan->info_harga2 ?? '-' }}</td>
                        </tr>
                        <!-- Informasi Harga 3 -->
                        <tr>
                            <td bgcolor="#f3f4f6" class="bg-label text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">3</td>
                            <td colspan="5" style="border: 1px solid #0A3370 !important; padding: 8px; white-space: pre-line; text-align: justify; text-justify: inter-word; vertical-align: top;">{{ $agunan->info_harga3 ?? '-' }}</td>
                        </tr>
                    </tbody>
                </table>
            @endforeach
