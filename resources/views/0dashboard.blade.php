...
<body class="bg-gray-100 font-sans min-h-screen flex flex-col justify-between relative overflow-x-hidden">
    ...
    <header class="bg-[#0A3370] text-white shadow-md py-4 border-b-4 border-[#0082CB] sticky top-0 z-50">
        <div class="max-w-6xl mx-auto px-4 flex justify-between items-center">
            ...
            <!-- Bagian Kanan: User-Friendly & Selaras -->
            <div class="flex items-center gap-3">
                
                <!-- Badge Identitas User (Dilengkapi Ikon & Status Online) -->
                <div class="hidden sm:flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-[#08285c]/80 border border-white/15 shadow-sm">
                    <!-- Ikon Profil Mini -->
                    <div class="w-6 h-6 rounded-full bg-[#0082CB] flex items-center justify-center text-white text-xs font-semibold shadow-inner">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                    </div>

                    <!-- Nama User & Titik Hijau Aktif -->
