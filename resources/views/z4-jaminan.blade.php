...
<body class="bg-[#F8FAFC] font-sans min-h-screen flex flex-col">
    ...
    <main class="max-w-3xl mx-auto mt-8 px-4 w-full flex-grow mb-12">
        ...
        <!-- FORM UTAMA -->
        <form id="formPraSurvei" action="{{ route('storeAlur4') }}" method="POST" class="space-y-6">
            @csrf 
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4">
                <h3 class="text-md font-bold text-[#0A3370] border-b pb-2 mb-2">JAMINAN LAINNYA</h3>

                <div>
                    <label for="jaminan_lainnya_jikaada" class="block text-sm font-medium text-gray-700 mb-1">
                        Isikan secara lengkap jaminan lainnya jika ada
                    </label>
                    <input type="text" id="jaminan_lainnya_jikaada" name="jaminan_lainnya_jikaada" 
                           value="{{ old('jaminan_lainnya_jikaada', $yangLain->jaminan_lainnya_jikaada ?? '') }}" 
                           placeholder="Masukkan rincian jaminan lainnya jika ada"
