        ...
        <div id="print-area" class="bg-white shadow-sm p-6 sm:p-8 border border-gray-200 rounded-none">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 pb-4 border-b border-gray-200 gap-4">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <a href="{{ route('1pra-survei', ['id' => $data->id]) }}" class="no-print inline-flex items-center gap-1.5 bg-amber-50 text-amber-800 border border-amber-200 px-4 py-2 rounded-lg text-base font-semibold hover:bg-amber-100 transition shadow-sm">
                    ...
                    <div class="relative inline-block text-left w-full sm:w-auto" x-data="{ open: false }">
                        ...
                        <div x-show="open" 
                            ...
                            <div class="p-1.5 space-y-0.5">
                                <a href="{{ route('riwayat.pdf', $data->id) }}" class="group flex items-center gap-2.5 px-3 py-2 text-base font-semibold text-gray-700 rounded-lg hover:bg-rose-50 hover:text-rose-700 transition-colors">
                                ...
                                <a href="{{ route('riwayat.word', $data->id) }}" class="group flex items-center gap-2.5 px-3 py-2 text-base font-semibold text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition-colors">
                                    <svg class="w-4 h-4 text-blue-500 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z"/></svg>
                                    <span>Word</span>
                                </a>
                                <a href="{{ route('riwayat.excel', $data->id) }}" class="group flex items-center gap-2.5 px-3 py-2 text-base font-semibold text-gray-700 rounded-lg hover:bg-emerald-50 hover:text-emerald-700 transition-colors">
            ...
            <!-- A. DATA DEBITUR -->
            <div class="mb-6">
                <div class="bg-[#0A3370] text-white px-3 py-1.5 font-bold text-sm uppercase rounded-none">
                    A. Data Debitur
                </div>
            ...
            @if(isset($data->agunan_tanah) && $data->agunan_tanah->count() > 0)
                <div class="mb-6">
                    @foreach($data->agunan_tanah as $index => $agunan)
                        ...
                        <div class="bg-[#0A3370] text-white px-3 py-1.5 font-bold text-sm uppercase {{ !$loop->first ? 'mt-6' : '' }}">
                            B. DATA {{ $data->agunan_tanah->count() > 1 ? 'JAMINAN KE-' . $urutanJaminan : 'JAMINAN' }}
                        </div>

                        <div class="border border-[#0A3370] {{ !$loop->last ? 'mb-4' : '' }} rounded-none text-sm">
            ...
            <div class="mb-6">
                ...
                <div class="border border-[#0A3370] rounded-none overflow-x-auto text-sm">
            ...
            <div class="mb-6">
                ...
                <div class="border border-[#0A3370] rounded-none p-2 bg-white whitespace-pre-line text-sm flex items-center" style="text-align: justify;">
