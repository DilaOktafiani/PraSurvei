...
<head>
    <meta charset="UTF-8">
    <title>Form Survey - {{ $data->nama ?? '-' }}</title>
    <style>
        @page {
            size: A4;
...
<body>
    ...
    <div class="page-container">
        ...
        <table class="export-table" style="table-layout: fixed;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="4" style="font-weight: bold; color: #000000;">Rp {{ number_format($data->plafon ?? 0, 0, ',', '.') }}</td>
                    <td colspan="2" class="bg-label">JKW</td>
                    <td colspan="2" style="font-weight: normal;">{{ $data->jangka_waktu ?? '-' }}</td>
                </tr>
                <!-- Tujuan Penggunaan -->
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="8" style="font-weight: bold; color: #000000;">Rp {{ number_format($data->estimasi_kewajiban ?? 0, 0, ',', '.') }}</td>
                </tr>
                <!-- Type Fasilitas -->
                <tr>
        ...
        <table class="export-table" style="width: 100%; border-collapse: collapse; border: 1px solid #0A3370 !important; margin-top: 10px; margin-bottom: 5px; table-layout: fixed;">
            <thead>
                <tr>
                    <th colspan="12" style="background-color: #0A3370 !important; color: #FFFFFF !important; font-weight: bold; padding: 6px 10px; text-transform: uppercase; border: 1px solid #0A3370 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; text-align: left;">
                        B. AGUNAN
                    </th>
                </tr>
            </thead>
            <tbody>
                <!-- Sub Header JAMINAN -->
                <tr>
                    <td colspan="12" style="background-color: #f3f4f6 !important; color: #0A3370 !important; font-weight: bold; text-transform: uppercase; border: 1px solid #0A3370 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 6px 10px; text-align: left;">Jaminan</td>
                </tr>
                
                <!-- Kepemilikan -->
                <tr>
                    <td colspan="3" class="bg-label" style="width: 25%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px;">Kepemilikan</td>
                    <td colspan="9" style="width: 75%; border: 1px solid #0A3370 !important; padding: 8px; font-weight: bold;">{{ $agunan->kepemilikan ?? '-' }}</td>
                </tr>
                
                <!-- Alamat -->
                <tr>
                    <td colspan="3" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px;">Alamat</td>
                    <td colspan="9" style="border: 1px solid #0A3370 !important; padding: 8px;">{{ $agunan->alamat ?? '-' }}</td>
                </tr>
                
                <!-- Share Loc -->
                <tr>
                    <td colspan="3" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px;">Share Loc</td>
                ...
                <tr class="sub-header" style="text-align: center; background-color: #f9fafb; color: #000000;">
                    ...
                    <td colspan="1" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; text-align: center; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; color: #000000;">Luas (m2)</td>
                    <td colspan="2" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; text-align: right; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; color: #000000;">Harga</td>
                    <td colspan="2" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; text-align: right; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; color: #000000;">Nilai Pasar</td>
                    <td colspan="2" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; text-align: right; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; color: #000000;">Nilai Taksasi</td>
                    <td colspan="3" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; text-align: right; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; color: #000000;">Nilai Likuidasi</td>
                </tr>
                <tr>
                ...
                <!-- Denah -->
                <tr>
                    <td colspan="3" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: middle;">Denah</td>
                    <td colspan="9" style="border: 1px solid #0A3370 !important; padding: 8px;">
                        @if(!empty($agunan->denah) && $agunan->denah !== '-')
                            <div style="width: 100%; max-width: 380px; border: 1px solid #d1d5db; border-radius: 4px; overflow: hidden; background: #fff;">
                                {{-- Gunakan public_path() agar DomPDF bisa membaca langsung dari storage lokal --}}
                ...
                <!-- Spesifikasi Jaminan -->
                <tr>
                    <td colspan="3" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top;">Spesifikasi Jaminan</td>
                ...
                <tr>
                    <td colspan="12" style="background-color: #f3f4f6 !important; color: #0A3370 !important; font-weight: bold; text-transform: uppercase; border: 1px solid #0A3370 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 6px 10px; text-align: left;">Informasi Harga</td>
                </tr>
                <!-- Informasi Harga 1 -->
                <tr>
                    <td class="bg-label text-center" style="width: 8%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">1</td>
                ...
                <!-- Informasi Harga 2 -->
                <tr>
                    <td class="bg-label text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">2</td>
                ...
                <!-- Informasi Harga 3 -->
                <tr>
                    <td class="bg-label text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">3</td>
        ...
        <table class="export-table" style="width: 100%; border-collapse: collapse; border: 1px solid #0A3370 !important; margin-top: 10px; margin-bottom: 5px; table-layout: fixed;">
            ...
            <tbody>
                ...
                <tr>
                    <td class="bg-label text-center" style="width: 8%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">D.1</td>
                    <td colspan="3" class="bg-label" style="width: 25%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top;">Informasi Penghasilan Utama menurut nasabah</td>
                ...
                <tr>
                    <td class="bg-label text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">D.2</td>
                    <td colspan="3" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top;">Informasi Penghasilan Pendukung menurut nasabah</td>
                ...
                <tr>
                    <td class="bg-label text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: middle; text-align: center;">D.3</td>
                    <td colspan="3" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: middle;">Pengeluaran Rumah Tangga</td>
                ...
                <tr>
                    <td class="bg-label text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: middle; text-align: center;"></td>
                    <td colspan="3" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: middle;">Angsuran Bank Lain</td>
                    <td colspan="8" class="whitespace-pre-line font-medium" style="border: 1px solid #0A3370 !important; padding: 8px; vertical-align: middle;">
                ...
                <tr>
                    <td class="bg-label text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: middle; text-align: center;"></td>
                    <td colspan="3" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: middle;">Angsuran BPR</td>
                    <td colspan="8" class="whitespace-pre-line font-medium" style="border: 1px solid #0A3370 !important; padding: 8px; vertical-align: middle;">
                ...
                <tr>
                    <td class="bg-label text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">D.4</td>
                    <td colspan="3" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top;">Analisis Kapasitas CA</td>
                ...
                <tr>
                    <td class="bg-label text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">D.5</td>
                    <td colspan="3" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top;">Kelengkapan Berkas</td>
        ...
        <table class="export-table" style="width: 100%; border-collapse: collapse; border: 1px solid #0A3370 !important; margin-top: 10px; margin-bottom: 5px; table-layout: fixed;">
            ...
            <tbody>
                <tr>
                    <td colspan="12" class="font-medium" style="border: 1px solid #0A3370 !important; padding: 8px; white-space: pre-line; text-align: left; vertical-align: top;">{{ $data->capital->analisis_aset ?? '-' }}</td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="export-table" style="width: 100%; border-collapse: collapse; border: 1px solid #0A3370 !important; margin-top: 10px; margin-bottom: 5px; table-layout: fixed;">
            ...
            <tbody>
                ...
                <tr>
                    <td class="bg-label text-center" style="width: 8%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">J.1</td>
                    <td colspan="3" class="bg-label" style="width: 25%; background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top;">Strengths (Kekuatan)</td>
                ...
                <tr>
                    <td class="bg-label text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">J.2</td>
                    <td colspan="3" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top;">Weaknesses (Kelemahan) dan Mitigasi</td>
                ...
                <tr>
                    <td class="bg-label text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">J.3</td>
                    <td colspan="3" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top;">Opportunities (Peluang)</td>
                ...
                <!-- J.4 Threats (Ancaman) -->
                <tr>
                    <td class="bg-label text-center" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top; text-align: center;">J.4</td>
                    <td colspan="3" class="bg-label" style="background-color: #f3f4f6 !important; border: 1px solid #0A3370 !important; font-weight: bold; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 8px; vertical-align: top;">Threats (Ancaman)</td>
                ...
                <tr>
                    <td colspan="12" class="sub-header" style="text-align: left; background-color: #f3f4f6 !important; color: #0A3370 !important; font-weight: bold; text-transform: uppercase; border: 1px solid #0A3370 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; padding: 6px 10px;">Kesimpulan</td>
                </tr>
                <!-- Isi Kesimpulan -->
                <tr>
