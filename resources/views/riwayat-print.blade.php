    ...
    <div class="page-container" style="margin-top: 0; padding-top: 0;">
        ...
        @if(isset($data->agunan_tanah) && $data->agunan_tanah->count() > 0)
            @foreach($data->agunan_tanah as $index => $agunan)
                ...
                <table class="export-table" style="width: 100%; border-collapse: collapse; border: 1px solid #0A3370 !important; margin-top: 10px; margin-bottom: 10px;">
                    <!-- Header Utama -->
                    <tr>
                        ...
                        <td colspan="5" style="border: 1px solid #0A3370 !important; padding: 0 !important;">
                            ...
                            <table style="width: 100%; border-collapse: collapse; border: none !important;">
                                @foreach($infoList as $infoIndex => $info)
                                    <tr>
                                        <td style="width: 10%; border-top: none; border-bottom: {{ $loop->last ? 'none' : '1px solid #d1d5db' }}; border-right: 1px solid #d1d5db; border-left: none; text-align: center; padding: 8px; background-color: #f9fafb; font-weight: 500;">{{ $infoIndex + 1 }}</td>
