...
<script>
    ...
    inputLainnya.addEventListener('input', function() {
        if (this.value.trim() !== '') {
            ...
            // Mengubah value checkbox agar sesuai dengan teks yang diinput user
            checkboxLainnya.value = this.value; 
        } else {
    ...
    // Pastikan juga saat checkbox dicentang manual, value-nya disesuaikan
    checkboxLainnya.addEventListener('change', function() {
        if(this.checked && inputLainnya.value.trim() !== '') {
            this.value = inputLainnya.value;
        } else {
            this.value = 'Yang Lain';
        }
    });
    ...
    function validateAndSubmit() {
        ...
        if (!isValid) {
            Swal.fire({
                ...
                confirmButtonColor: '#0082CB', // Disesuaikan dengan warna tema utama
                heightAuto: false,
                customClass: {
            ...
            if(checkboxLainnya.checked && inputLainnya.value.trim() !== '') {
                checkboxLainnya.value = inputLainnya.value;
            }
